...
def build_vegetation_group_from_ndvi_csv(
    ...
    """Costruisce il canale NDVI dal CSV ufficiale BioCube quando è disponibile."""
...
def build_vegetation_group_from_sources(
    ...
    """Preferisce il CSV NDVI ufficiale BioCube; altrimenti usa zero placeholder."""
...
def build_raw_batch_for_months(
    ...
    raw_batch = {
        ...
        "vegetation_variables": build_vegetation_group_from_sources(
